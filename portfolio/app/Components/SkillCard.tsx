...
export default function NameCard() {
    ...
    return (
        <div className="flex flex-col z-30">
            <h2 className="text-3xl font-medium self-center mb-4 bg-clip-text bg-gradient-to-b from-secondary-500 to-secondary-300 inline-block text-transparent">My skills</h2>
